...
/**
*
*  BTI717 DRIVER EXAMPLE 8  (06/07/2011)
            ...
            **/
	        ...
	        while(0 == Win32Interop._kbhit())
	        {
                ...
                while (0 == BTICARD.BTICard_SeqFindNext717Ex(ref pRec717, (UInt16)Marshal.SizeOf(pRec717), ref sfinfo))
                {
                    ...
                    Console.Write("  TimeStamp:{0:d2}:{1:d2} {2:d2}.{3:d3}.{4:d3}",
				        BTICARD.BTICard_IRIGFieldGetHours(pRec717.timestamph,pRec717.timestamp),
				        BTICARD.BTICard_IRIGFieldGetMin(pRec717.timestamph,pRec717.timestamp),
				        BTICARD.BTICard_IRIGFieldGetSec(pRec717.timestamph,pRec717.timestamp),
				        BTICARD.BTICard_IRIGFieldGetMillisec(pRec717.timestamph,pRec717.timestamp),
				        BTICARD.BTICard_IRIGFieldGetMicrosec(pRec717.timestamph,pRec717.timestamp));
		        }
	        }
