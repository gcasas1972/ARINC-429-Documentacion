...
INT minperiod[5] = {100,100,100,400,400};
INT maxperiod[5] = {200,200,200,500,500};
...
*   ALL RIGHTS RESERVED
*
*   NAME:   DEMO4.C -- Schedule Built Sample Program.
*
**/
...
*
*   CL DEMO4.C P42W32.LIB
*
*   To compile this program with the Borland C++ compiler, use
*   the following command line:
*
*   BCC32 DEMO4.C P42W32.LIB
*
**/

USHORT xmitchan = CH1;		//Assume transmit channel on channel 1
USHORT rcvchan  = CH0;		//Assume receive  channel on channel 0
...
VOID main(VOID)
{
	...
	fprintf(stderr,"DEMO4  Version 1.0  (03/31/1999)\n");
...
**/
	...
	errval = PC429_SchedBuild(5,minperiod,maxperiod,0,xmitchan,handleval);
...
**/
	...
	for (j=0;j<PC429_GetMsgCnt(xmitchan,handleval);++j)
	{
		printf("\nindex=%2u msg=%08lX gap=%08lX",j,PC429_GetMsg(j,xmitchan,handleval),PC429_GetGap(j,xmitchan,handleval));
	}
