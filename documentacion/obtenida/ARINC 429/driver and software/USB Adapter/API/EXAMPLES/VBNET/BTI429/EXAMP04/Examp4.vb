...
Friend Class Form1
    ...
    Dim xmt_altitude As BTI429VB.MSGSTRUCT429
    Dim rcv_airspeed As BTI429VB.MSGSTRUCT429
    Dim rcv_altitude As BTI429VB.MSGSTRUCT429
    Dim airspeed_record As BTI429VB.MSGFIELDS429
    Dim altitude_record As BTI429VB.MSGFIELDS429
    ...
    Private Sub cmdStart_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdStart.Click
        ...
        rcv_altitude.addr = BTI429_FilterSet(MSGCRT429_DEFAULT, &O212S, SDIALL, rcvchan, hCore)
        ...
        Call BTI429_MsgDataWr(&H8AS, xmt_altitude.addr, hCore)
...
Errhandler:
	...
	Private Sub Timer1_Tick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Timer1.Tick
        ...
        Label1.Text = "AirSpeed: min/max=" & CStr(airspeed_record.mintime / 1000) & "ms/" & CStr(airspeed_record.maxtime_elapsetime / 1000) & "ms"
        Label2.Text = "Altitude: min/max=" & CStr(altitude_record.mintime / 1000) & "ms/" & CStr(altitude_record.maxtime_elapsetime / 1000) & "ms"
