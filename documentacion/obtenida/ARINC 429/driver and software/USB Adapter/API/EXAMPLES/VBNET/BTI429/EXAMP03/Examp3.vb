...
Friend Class Form1
	...
	'
    '  BTI429 DRIVER VB.NET EXAMPLE 3  
...
Errhandler:
	...
	Private Sub Timer1_Tick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Timer1.Tick
        ...
        errval = BTICard_SeqFindInit(seqbuf(0), CType(seqcount, UInteger), sfinfo)
        If (0 > errval) Then
        ...
        While (0 <= BTICard_SeqFindNext429Ex(pRec429, CType(Len(pRec429), UShort), sfinfo))
