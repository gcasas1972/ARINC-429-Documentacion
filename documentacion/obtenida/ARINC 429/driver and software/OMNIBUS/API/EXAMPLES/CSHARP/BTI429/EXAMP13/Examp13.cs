...
/**
*
*  BTI429 DRIVER EXAMPLE 13  (06/07/2011)
...
namespace EXAMP13
{
    ...
    class Examp13
    {
        ...
        static void Main(string[] args)
        {
	        ...
	        UInt16[] seqbuf = new UInt16[32768];
	        UInt32 seqcount = 0;
            UInt32 blkcnt = 0;
            ...
            **/
	        ...
	        errval = BTI429.BTI429_ChConfig(BTI429.CHCFG429_SEQALL,xmtchan,hCore);      /*Configure channel*/
            ...
            **/
	        ...
	        errval = BTICARD.BTICard_SeqConfig(BTICARD.SEQCFG_DEFAULT | BTICARD.SEQCFG_DMA ,hCore);
            ...
            **/
	        ...
	        {
                seqcount = BTICARD.BTICard_SeqDMARd(ref seqbuf[0], (UInt32)seqbuf.Length, hCore);
