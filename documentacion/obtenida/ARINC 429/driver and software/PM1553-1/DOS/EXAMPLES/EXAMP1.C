/**
*
*  PM1553-1 EXAMPLE 1  Version 1.0  (04/15/2002)
*  Copyright (c) 2002
...
// Prototypes
VOID PM11Ex1_ConfigSummitBC(USHORT port);  // Summit configuration prototype
...
VOID PM11Ex1_ConfigSummitBC(USHORT port)
{
	...
	PM11_SummitWr(0x0000,0x0059,port);	// (Not used in this example)
