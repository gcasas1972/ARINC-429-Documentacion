...
/**
*
*  PC708-1 DRIVER EXAMPLE 2  Version 1.1  (07/28/1998)
*  Copyright (c) 1998
...
**/
		...
		{
			PC708_IntRd(NULL,&framenum,Card);

			if (framenum==1)
			{
				PC708_XmtRd(Data0,0,Card);		/*Read data for message 0*/
				PC708_XmtRd(Data1,1,Card);		/*Read data for message 1*/
			...
			if (framenum==3)
			{
				PC708_XmtRd(Data2,2,Card);		/*Read data for message 2*/
				PC708_XmtRd(Data3,3,Card);		/*Read data for message 3*/
