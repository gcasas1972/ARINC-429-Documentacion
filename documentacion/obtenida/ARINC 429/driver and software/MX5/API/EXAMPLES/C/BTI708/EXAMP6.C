...
/**
*
*  BTI708 DRIVER EXAMPLE 6  (06/09/2011)
...
**/
	...
	while (!kbhit())
	{
		...
		printf("\nTilt:           %04X (Hex)  %f (Dec)",BTI708_FieldGetTilt(Data),BTI708_FieldGetTiltFl(Data));
		...
		printf("\nScan Angle:     %03X (Hex)  %f (Dec)",BTI708_FieldGetAngle(Data),BTI708_FieldGetAngleFl(Data));
