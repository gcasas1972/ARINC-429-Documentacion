...
/**
*
*  LP1553-3 DRIVER EXAMPLE 9  Version 1.0  (08/20/1998)
*  Copyright (c) 1998
...
*  ALL RIGHTS RESERVED
*  
*  NAME:   INTPOLL.C -- Modified Example 9.
*                      "Polled Interrupts"
*
**/
...
/**
*
*  This example configures the LP1553-3 as a bus controller
...
typedef struct						/*Variables used by the thread*/
{
	...
	HCARD   Card;					/*Handle of LP1553-3 card*/
...
void main(void)
{
	...
	fprintf(stderr,"\nINTPOLL  Version 1.0  (08/20/1998)");
...
**/
	...
	Card = L13_CardOpen(CARDNUM);					/*Open the LP1553-3 card*/
...
**/
	...
	L13_CardReset(Card);							/*Reset the LP1553-3 card*/

	errval = L13_BCConfig(BCCFG_DEFAULT,Card);		/*Configure the LP1553-3 card*/
