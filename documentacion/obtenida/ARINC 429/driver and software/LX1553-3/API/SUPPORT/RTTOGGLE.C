		...
		if (kbhit())
		{
			...
			switch(ch)
			{
				...
				case '1':
					...
					{
						printf("\nDisabing RT1");
						L13_RTConfig(RTCFG_MONITOR, 1, handleval);
						rt1=0;
					}
					else
					{
						printf("\nEnabling RT1");
						L13_RTConfig(RTCFG_SIMULATE, 1, handleval);
						rt1=1;
					}
					break;
				...
				case '2':
					...
					{
						printf("\nDisabing RT2");
						L13_RTConfig(RTCFG_MONITOR, 2, handleval);
						rt2=0;
					}
					else
					{
						printf("\nEnabling RT2");
						L13_RTConfig(RTCFG_SIMULATE, 2, handleval);
						rt2=1;
					}
					break;
				...
				case '3':
					...
					{
						printf("\nDisabing RT3");
						L13_RTConfig(RTCFG_MONITOR, 3, handleval);
						rt3=0;
					}
					else
					{
						printf("\nEnabling RT3");
						L13_RTConfig(RTCFG_SIMULATE, 3, handleval);
						rt3=1;
					}
					break;
			}
