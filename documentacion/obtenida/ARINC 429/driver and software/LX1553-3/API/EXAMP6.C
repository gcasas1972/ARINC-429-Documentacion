...
/**
*
*  LP1553-3 and LC1553-3 DRIVER EXAMPLE 6  Version 1.0  (10/29/2001)
...
*  configures the L13 as a BC and transmits a single
...
void main(void)
{
	...
	fprintf(stderr,"\n");
	fprintf(stderr,"\nLP1553-3 and LC1553-3 Example 6");
	fprintf(stderr,"\n\"Errors in BC Transmissions - Unscheduled Messages\"");
	fprintf(stderr,"\n");
...
**/
	...
	L13_ErrorDefine(ERRDEF_PAR, 0, 0, ERRDEF_CWD1, 0, Card);
	L13_ErrorCtrl(ERRCTRL_ONCE | ERRCTRL_ANYMSG, Card);
...
**/
	...
	errval = L13_BCTransmitMsg(&Msg, Card);
