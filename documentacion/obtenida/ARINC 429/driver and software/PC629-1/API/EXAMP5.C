...
/**
*
*   PC629-1 EXAMPLE 5 PROGRAM  Version 1.0  (07/05/2002)
...
*   ALL RIGHTS RESERVED
*
*   NAME:   EXAMP5.C -- RAM Dumping Program.
*
**/

/**
*
*   This program dumps the contents of the RAM on the PC629-1
...
/**
*
*   Loop through RAM and display data.
*
**/
	...
	for (j=0;j<0x10000 && !kbhit();++j)
	{
		...
		printf("%04X ",PC629_RamRdW(0,j,handleval));
	}
