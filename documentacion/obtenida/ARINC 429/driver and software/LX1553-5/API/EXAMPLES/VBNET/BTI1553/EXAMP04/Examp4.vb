...
Friend Class Form1
	...
	'
    '  BTI1553 DRIVER VB.NET BTI1553 EXAMPLE 4  (06/07/2011)
...
Errhandler:
    ...
    Private Sub Timer1_Tick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Timer1.Tick
        ...
        While (0 <= BTICard_SeqFindNext1553Ex(pRec1553, CUShort(Marshal.SizeOf(pRec1553)), sfinfo))
            ...
            str_Renamed = str_Renamed & "  Time:" & Hex(pRec1553.timestamp)
            ...
            If CBool(BTICard_SeqFindCheckVersion(pRec1553.typeval, SEQVER_1)) Then
                If 0 = BTICard_SeqFindMore1553Ex(pRecMore1553, CUShort(Marshal.SizeOf(pRecMore1553)), pRec1553) Then
                    str_Renamed = str_Renamed & "  RespTime1:" & Hex(pRecMore1553.resptime1)
                End If
            End If
