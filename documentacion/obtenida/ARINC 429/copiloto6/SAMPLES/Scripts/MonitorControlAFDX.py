"""	MonitorControl.py : COPILOT PYTHON SCRIPT EXAMPLE
	...
	Notes:		ARINC 429 labels/fields and MIL-STD-1553 fields can also be
                        used in place of the "Field1" object.

	Databuses:	AFDX/ARINC 664, ARINC 429, MIL-STD-1553
"""
